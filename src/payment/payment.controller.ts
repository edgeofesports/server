...
export const createOrder_C = async (req: Request, res: Response) => {
  ...
  try {
    const totalOrders = await (
      await razorpayOrders.aggregate([{ $count: "length" }])
    )[0].length;
...
export const createPaymentOption_C = async (req: Request, res: Response) => {
...
export const razorpayPaymentHandler_C = async (req: Request, res: Response) => {
